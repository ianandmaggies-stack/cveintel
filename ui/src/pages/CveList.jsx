    ...
    <div>
      ...
      <div style={{ background: '#111', border: '0.5px solid #2a2a2a', borderRadius: '10px', overflow: 'hidden' }}>
        {cves.map((cve, i) => {
          ...
          return (
            <div key={cve.cve_id} style={{ padding: '10px 16px', borderBottom: i < cves.length - 1 ? '0.5px solid #1a1a1a' : 'none',
              display: 'grid', gridTemplateColumns: '120px 1fr auto auto', gap: '12px', alignItems: 'center' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '12px' }}>
        <span style={{ ...mono, fontSize: '11px', color: '#666' }}>Page {meta.page} of {meta.pages}</span>
